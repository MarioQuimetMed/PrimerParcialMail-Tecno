package com.tecnoweb.grupo15sa.communication;

import com.tecnoweb.grupo15sa.interfaces.IEmailEventListener;
import com.tecnoweb.grupo15sa.utils.Command;
import com.tecnoweb.grupo15sa.utils.Email;
import com.tecnoweb.grupo15sa.utils.Extractor;
...
public class MailVerificationThread implements Runnable {
    ...
    private final static String USER = "grupo15sa";
    private final static String PASSWORD = "grup015grup015*";
